...
@section('title')Blog View @endsection
                    ...
                    <div class="col-lg-8 m-15px-tb">
                        <article class="article">
                            <div class="article-img">
                                <img src="{{$blog->getPicture()}}" width="800" height="350" title="" alt="">
                            </div>
                            <div class="article-title">
                                <h2>{{{$blog->title}}}</h2>
                                <div class="media">
                                    <div class="avatar">
                                        <img src="{{$blog->author->getPicture()}}" title="" alt="">
                                    </div>
                                    <div class="media-body">
                                        <label>{{$blog->author->getFullName()}}</label>
                            ...
                            <div class="nav tag-cloud">
                                ...
                                <a style="color:white">{{$category->name}}</a>
                                @endforeach
                            </div>
                        </article>
                    </div>
                            ...
                            <div class="widget-body">
                                ...
                                <div class="latest-post-aside media">
                                    <div class="lpa-left media-body">
                                        ...
                                        <div class="lpa-meta">
                                            <a class="name" href="#">
                                                {{$l_blog->author->getFullName()}}
                                            </a>
                                            <a class="date" href="#">
                                                {{\Carbon\Carbon::parse($l_blog->created_at)->format('d-m-Y')}}
                                            </a>
                                        </div>
                                    </div>
                                    <div class="lpa-right">
