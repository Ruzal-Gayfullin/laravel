...
Route::name('blog.')->group(function () {
    ...
    Route::get('/blog/{slug}', [\App\Http\Controllers\BlogController::class, 'BlogView'])
    ...
    Route::match(['GET', 'POST'], 'blog/update/{slug}', [\App\Http\Controllers\BlogController::class, 'BlogUpdate'])
        ->whereAlphaNumeric('slug')
        ->name('blog-update')
        ->middleware('auth');
